...
\033[1;92m--------------------------------------------------➤
\033[1;93m➣ Author      : Zabihullah Abdall
\033[1;93m➣ YouTube     : Zabi Obaidi
\033[1;92m➣ Facebook    : Zabi Obaidi
\033[1;92m--------------------------------------------------➤
  ''')
    print('' + Back.BLUE + Fore.BLACK + '        Creator : zabihullah_abdall         \033[00m')
    print()
...
def masuk():
    try:
          ...
          cek = input("cookies lern 👉      Zabi Obaidi   👈👈  plese subscrib youtube chanel👈👈👉👉enter \033[00mCookies : \033[1;96m")
    cek = {"cookie":cek}
